...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup.fg.color(theme.fg_widget, "U" .. net_now.sent .. "D" .. net_now.received .. " ")))
    end
})
local net_widget =  wibox.container.background(wibox.container.margin(wibox.widget { net_icon, net.widget, layout = wibox.layout.align.horizontal }, 0, 0), theme.pink)
