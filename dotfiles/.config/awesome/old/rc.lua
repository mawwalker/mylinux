...
beautiful.init("/home/dsm/.config/awesome/theme.lua")
...
myawesomemenu = {
   ...
   { "poweroff", function() os.execute("systemctl poweroff") end },
}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "w", function () awful.spawn(browser) end,
              {description = "google-chrome-stable", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "n", function () awful.spawn(filemanager) end,
              {description = "nemo", group = "launcher"}),
